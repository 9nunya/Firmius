...
export interface IBudgetComponents {
  tracker: import("./BudgetTracker").BudgetTracker;
  rollingBuffer: import("./RollingResultBuffer").RollingResultBuffer;
  fileWatchBudget: import("./FileWatchBudget").FileWatchBudget;
  protectedContext: import("./ProtectedContext").ProtectedContext;
